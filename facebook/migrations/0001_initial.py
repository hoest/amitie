...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Person'
        db.create_table('facebook_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('lastname', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('initials', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('member_since', self.gf('django.db.models.fields.DateField')()),
            ('phonenumber', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('cellphone', self.gf('django.db.models.fields.CharField')(max_length=12, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('facebook', ['Person'])


    def backwards(self, orm):
        # Deleting model 'Person'
        db.delete_table('facebook_person')
    ...
    models = {
        ...
        'facebook.person': {
            ...
            'cellphone': ('django.db.models.fields.CharField', [], {'max_length': '12', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initials': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'lastname': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'member_since': ('django.db.models.fields.DateField', [], {}),
            'phonenumber': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
